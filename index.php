...
if(!$_SESSION[font_size_arab]) 		$_SESSION[font_size_arab] = 30;

if(!$_SESSION[font_family_arab]) 	$_SESSION[font_family_arab] = "PDMS_IslamicFont";
...
//-------------------------------------------
*/
include("themes/{$themes}/index.html");
?>
